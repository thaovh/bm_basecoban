...
export class UpdateRoomDto {
    @ApiProperty({ description: 'Room code', example: 'R001', required: false })
    @IsOptional()
    @IsString()
    @MinLength(1)
    @MaxLength(20)
    ...
    @ApiProperty({ description: 'Room name', example: 'Phòng Khám Tim Mạch 1', required: false })
    @IsOptional()
    @IsString()
    @MinLength(1)
    @MaxLength(200)
    ...
    @ApiProperty({ description: 'Room address', example: 'Tầng 2, Khu A, Khoa Tim Mạch', required: false })
    @IsOptional()
    @IsString()
    @MinLength(1)
    @MaxLength(500)
    ...
    @ApiProperty({ description: 'Department ID', example: 'f1b42d3b-eccf-40f2-8305-4ee4cac61525', required: false })
    @IsOptional()
    @IsUUID()
    departmentId?: string;
